    ...
    auth
      ...
      .catch((error) => {
        ...
        if (errorCode === "auth/invalid-email") {
          ...
          errorCode =
            "이메일 주소가 사용 중입니다. 다른 이메일 주소를 시도하십시오.";
        } else {
    ...
    auth
      ...
      .catch((error) => {
        ...
        if (errorCode === "auth/invalid-email") {
          ...
          errorCode =
            "이메일 주소가 사용 중입니다. 다른 이메일 주소를 사용하십시오.";
        } else {
  ...
  return (
    <LoginDiv>
      ...
      <RegisterModal
        closeTimeoutMS={400}
        ariaHideApp={false}
        isOpen={regiModalIsOpen}
        onRequestClose={() => setRegiModalIsOpen(false)}
        style={{
          overlay: {
        ...
        <RegiForm>
          ...
          <ClauseDiv>
            <Clause>
              ...
              권한이 거부되거나 그 외 몇 개의 경우에 한하여 api-key가
              노출됩니다. <br />
              API는 Firebals/Google 서비스와 상호 작용할 때 Firebase 프로젝트를
              식별합니다.
              <br />
              Google Firebase JS는 API에 대하여 공개가 되어도 문제가 되지
              않는다고 밝혔으나,
              <br />
